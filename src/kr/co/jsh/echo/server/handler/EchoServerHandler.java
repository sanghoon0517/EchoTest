...
//@Sharable 어노테이션은 Race Condition 없이, 하나 또는 다수의 파이프라인에 여러번 추가할 수 있다
...
public class EchoServerHandler extends ChannelInboundHandlerAdapter{
	...
	public void channelRead(ChannelHandlerContext ctx, Object msg) throws Exception {
		...
		String response = "FIXED TEST RESPONSE DATA를 전송합니다.";
		...
		ctx.writeAndFlush(out); //채널 활성화 시 응답 메시지 전송
	}
